...
usage: linkedin-jobs-scrape [-h] [--jobs JOBS] [--remote-collection] [--sleeptime SLEEPTIME] [--outset OUTSET]

options:
  -h, --help            show this help message and exit
  --jobs JOBS, -j JOBS  int, number of jobs to scrape
  --remote-collection, -rc
                        results from LinkedIn remote jobs collection
